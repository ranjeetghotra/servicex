...
const HeatPump = () => {
    ...
    return (
        <>
            <PageHeader title="Heat pump servicing and maintenance" breadcrumb={[{ title: 'Services', to: '/services' }]} />
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="border-start border-5 border-primary ps-4 mb-5">
                                ...
                                <h1 class="display-6 mb-0">Heat pump servicing and maintenance</h1>
            ...
            <AppointmentForm ref={myRef} selectedservice="Child Name" />
        </>
    );
};
